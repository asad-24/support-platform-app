...
import { ClipboardCheck, School, ShieldCheck, Users } from "lucide-react";
      ...
      <div className="grid min-h-screen lg:grid-cols-2">
        <section className="hidden bg-gradient-to-br from-sidebar via-sidebar to-sidebar-accent p-12 text-sidebar-foreground lg:flex lg:flex-col lg:justify-between">
          <div className="flex items-center gap-3">
            <div className="flex size-12 items-center justify-center rounded-full bg-sidebar-primary text-sidebar-primary-foreground shadow-lg">
              <ShieldCheck className="size-6" />
            </div>
            <div>
              <div className="text-xl font-semibold">Support Atlas</div>
          ...
          <div className="max-w-2xl">
            ...
            <p className="mt-5 max-w-xl text-base text-sidebar-foreground/75">
              Support Atlas keeps field submissions, registration reviews, and operational notifications close together for fast admin decisions.
            </p>
          </div>
        ...
        <section className="flex items-center justify-center p-6 md:p-10 xl:p-14">
          <div className="w-full max-w-2xl">
            <div className="mb-8 flex items-center gap-3 lg:hidden">
              <div className="flex size-12 items-center justify-center rounded-full bg-sidebar text-sidebar-foreground shadow-lg">
                <ShieldCheck className="size-6" />
              </div>
              <div>
                <div className="text-xl font-semibold">Support Atlas</div>
