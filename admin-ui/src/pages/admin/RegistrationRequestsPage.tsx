...
import type { VolunteerApplication, VolunteerApplicationStatus } from "@app/lib/types";
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Review volunteer applications and approve or reject access."
        action={
      ...
      <Sheet open={drawerOpen} onOpenChange={setDrawerOpen}>
        <SheetContent className="w-full overflow-y-auto sm:max-w-2xl">
          ...
          <div className="flex-1 space-y-5 px-4">
            {detailLoading && <div className="rounded-2xl border border-dashed p-6 text-center text-sm text-muted-foreground">Loading application...</div>}
              ...
              <>
                ...
                <div className="grid gap-3 sm:grid-cols-2">
                  {applicationFields(selected).map((field) => (
                    <div key={field.label} className="rounded-2xl border bg-card p-3">
