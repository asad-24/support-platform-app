module.exports = [
  ...
  { method: 'PATCH', path: '/me/volunteer-profile', name: 'me.volunteerProfile', middleware: ['auth', 'UploadMiddleware.single(profileImage)'], handler: 'user/UserController.update_volunteer_profile' },
